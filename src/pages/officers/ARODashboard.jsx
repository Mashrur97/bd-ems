...
export default function ARODashboard() {
  ...
  const sidebarItems = [
    { id: "compile", icon: <BarChart2 size={16} />, label: "Compile Results" },
    { id: "stations", icon: <Building2 size={16} />, label: "All Stations" },
    { id: "flags", icon: <Flag size={16} />, label: "Fraud Flags" },
  ];
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 p-4 md:p-8 overflow-auto pb-24 md:pb-8">
          ...
          {section === "compile" && (
            <div>
              <div className="flex items-center gap-2 text-2xl font-bold mb-1">
                <BarChart2 size={24} className="text-purple-400" /> Constituency Compilation
              </div>
          ...
          {section === "flags" && (
            <div>
              <div className="flex items-center gap-2 text-2xl font-bold mb-6">
                <Flag size={24} className="text-purple-400" /> Fraud & Anomaly Flags
              </div>
              {fraudFlags.length === 0 ? (
